...
description: 'Artikkeli Pohjanmaan ratsukomppaniasta Kustaa II Adolfin aikana, Johan Printzistä ja komppanian vaiheista Preussissa ja Saksassa.'
pubDate: 2020-08-15
sourceUrl: 'https://www.toisetaijat.fi/2020/08/pohjanmaan-ratsukomppania-1620-ja-1630.html'
heroImage: '/images/pohjanmaan-ratsukomppania-1620-ja-1630/pohjansota-1620-1.jpg'
tags: ['ratsuväki', '30-vuotinen sota', 'Pohjanmaa']
---
...
<Figure src="/images/pohjanmaan-ratsukomppania-1620-ja-1630/pohjansota-1620-2.jpg" alt="Johan Printzin omakätinen nimikirjoitus vuoden 1638 katselmusrullan lopusta" caption="Johan Printzin omakätinen nimikirjoitus vuoden 1638 katselmusrullan lopusta" placement="right" size="small" />

Maaliskuun lopussa Pommerin Stolpessa rivissä oli 25, kotona 10, vankina 9, Wittstockissa kaatuneita 3, tauteihin kuolleita 32 ja karkureita vain kolme. Lisäksi oli kaksi alipäällystöön ylennettyä ja yksi sairaana jälkeen jäänyt. Samaan aikaan Pohjanmaalla koottiin uusia ratsukoita Saksaan lähetettäväksi. Näitä oli 72.

Printzin johdolla Stettiniin tuli 10. heinäkuuta 1638 suuri joukko uusia alokkaita. Pohjalaiskomppanian rivivahvuus oli 92, kun se katsastettiin Tribseesissä 7. elokuuta. Pohjalaiskomppanian uudeksi ratsumestariksi tuli Nils Thomasson.

## Ratsukomppanian lakkautus

Pohjanmaalla uudelleen muodostettava komppania oli läsnä Vähäkyrön pappilassa 1.9.1640. Uudelleen Pohjanmaalla koottua komppaniaa ei kuitenkaan lähetetty Saksaan. Kun Turun ja Porin läänin ratsuväen täydennykset katsastettiin Turun linnassa 28. kesäkuuta 1641 sotaan lähettämistä varten, todetaan, että pohjalaiskomppania on erityisistä syistä lakkautettu. Nils Thomasson sai uuden komppanian johdettavakseen. Läänissä tehtiin komppanioiden välillä järjestelyjä niin, että lakkautuksesta huolimatta rykmentissä oli kahdeksan komppaniaa. Niiden alueet keskitettiin Pohjanmaan eteläpuolelle.[6]

Ratsuväen pohjalaiskomppania oli ollut olemassa vähän yli kymmenen vuotta. Saksaan jääneet ratsumiehet ratsastivat siellä niin kauan kuin pystyivät. Sitkeimmät olivat vielä muutama vuosi myöhemmin hengissä ja palveluksessa.
...
<Figure src="/images/pohjanmaan-ratsukomppania-1620-ja-1630/pohjanmaan-ratsukomppania-1620_page_5.jpg" alt="Ote Karl Bäckin komppanian rullasta 26. lokakuuta 1641, sivu 5" caption="Ote Karl Bäckin komppanian rullasta 26. lokakuuta 1641" placement="center" size="full" />

<Figure src="/images/pohjanmaan-ratsukomppania-1620-ja-1630/pohjanmaan-ratsukomppania-1620_page_6.jpg" alt="Ote Karl Bäckin komppanian rullasta, sivu 6" placement="center" size="full" />

<Figure src="/images/pohjanmaan-ratsukomppania-1620-ja-1630/pohjanmaan-ratsukomppania-1620_page_7.jpg" alt="Ote Karl Bäckin komppanian rullasta, sivu 7" placement="center" size="full" />
...
[4] Jos lähdettä ei ole aina täsmennetty, se perustuu alussa mainittuun käsikirjoitukseen.
